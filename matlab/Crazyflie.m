classdef Crazyflie
  properties
    ...
    Q = diag([20 20 1000 1 1 20 .001 .001 .001 1 1 5]);
    R = eye(4);
    ...
    tvQ = diag([20 20 70 10 10 200 .001 .001 .001 1.5 1.5 1]);
    %tvQf = diag([100 100 100 10 10 200 .001 .001 .001 1.5 1.5 1]);
    tvQf = diag([10 10 100 1 1 1 1 1 1 1 1 1]);
    tvR = eye(4);
  end
