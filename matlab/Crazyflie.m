classdef Crazyflie
  properties
    ...
    tvQ = diag([25 25 25 1 1 5 .001 .001 .001 3.5 3.5 5.0]);
    %tvQ = diag([200 200 300 1 1 25 .001 .001 .001 2.0 2.0 5.0]);
    %tvQ = diag([50 50 75 1 1 25 .1 .1 .1 2.0 2.0 5.0]);
    %tvQ = diag([50 50 75 1 1 25 5 5 7.5 2.0 2.0 5.0]);
    tvR = eye(4);
