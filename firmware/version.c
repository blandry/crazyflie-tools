...
const char * V_SLOCAL_REVISION="mitrll+";
const char * V_SREVISION="577875c485fb";
const char * V_STAG="2014.10.24";
const char * V_BRANCH="master";
const char * V_PROFILE=P_NAME;
const bool V_MODIFIED=true;

/* Version recoverable from the ground */
const uint32_t V_REVISION_0=0x577875c4;
const uint16_t V_REVISION_1=0x85fb;
